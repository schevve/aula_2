 ...
 * chama a camada de serviço para processar a lógica e retorna a view (página
 * HTML).
 *
 ...
 * @RequestMapping - Define o prefixo "/alunos" para todas as rotas deste
 *                 controller.
 * @RequiredArgsConstructor - Lombok: injeta automaticamente as dependências via
 *                          construtor.
 */
@Controller
...
public class AlunoController {
     ...
     *
     * O objeto "Model" é usado para enviar dados do Controller para a View
     * (template HTML).
     * Adicionamos a lista de alunos ao model com a chave "alunos", que será
     * acessada no HTML.
     */
    @GetMapping
     ...
     *
     * Enviamos um objeto Aluno vazio para o formulário poder fazer o binding dos
     * campos.
     */
    @GetMapping("/novo")
     ...
     *
     * @param aluno              - Objeto preenchido automaticamente com os dados do
     *                           formulário.
     * @param redirectAttributes - Permite enviar mensagens flash (mensagens
     *                           temporárias após redirect).
     */
    @PostMapping("/salvar")
